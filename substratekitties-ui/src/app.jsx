...
class SubstratekittiesSegment extends React.Component {
    ...
    render() {
        return <Segment style={{ margin: '1em' }} padded>
            ...
            <div style={{ paddingBottom: '1em' }}></div>
            <AccountIdBond bond={this.accountId} />
            <If condition={this.accountId.ready()} then={
                <Label>Kitties owned
                    <Label.Detail>
                        <Pretty value={runtime.substratekitties.ownedKittiesCount(this.accountId)} />
                    </Label.Detail>
                </Label>
            } />
            <div style={{ paddingBottom: '1em' }}></div>
